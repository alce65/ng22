...
import { RadioButtons } from '../../../../core/components/UI/radio-buttons/radio-buttons-free';
import { Select } from '../../../../core/components/UI/select/select-free';
...
// Versión inicial usando los custom "free"
// que no dependen de un formulario externo

@Component({
  selector: 'alc-register-form-customs',
  imports: [FormRoot, JsonPipe, CheckBoxFree, RadioButtons, Select, Input],
  template: `
